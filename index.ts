...
const answer = await inquirer.prompt([
    { message: chalk.yellow.bold("Enter first number"), type: "number", name: "firstNumber" },    //array []  //{} object   ==>is a datatype in javascript that carry multitypes of similar data. 
    { message: chalk.yellow.bold("Enter second number"), type:  "number", name: "secondNumber" },   // [{key: enter number, type , name }]  //key=messge,name
    {
